...
import reduce from '../reduce/reduce-recursive'
import reduceRight from '../reduce/reduceright-recursive'
...
describe('Reduce Tests', () => {
  ...
  it('09 Reduce Right reduceRight(["nny", "la", "mchi"], (acc, item) => acc + item, "") should return "mchilanny"', () => {
